...
class AuthService{
  static Future <dynamic> login(Auth auth) async{
    var dio = Dio();
    try{
  ...
  static Future <dynamic> register(Auth auth) async{
    var dio = Dio();
    try{
  ...
  static Future <dynamic> changePasword(String password, String newPassword, String accessToken) async{
    var dio = Dio();
    try{
  ...
  static Future <dynamic> loginByFaceBook(String token) async{
    var dio = Dio();
    try{
  ...
  static Future <dynamic> loginByGoogle(String token) async{
    var dio = Dio();
    try{
